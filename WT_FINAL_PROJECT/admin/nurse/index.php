  ...
  <body>
    ...
    <div class="admin-wrapper">
      ...
      <div class="admin-content">
        <div class="button-group">
          ...
          <a style="background:grey;pointer-events: none;" href="index.php" class="btn btn-big">Manage nurse</a>
        </div>
    ...
    <script>
        function MyAjaxFunc(){
          ...
          xhttp.open("GET", "/HospitalManagementSystem/admin/nurse/load.php", true);
        ...
        function showmyuser() {
          ...
          xhttp.open("POST", "/HospitalManagementSystem/admin/nurse/search.php", true);
