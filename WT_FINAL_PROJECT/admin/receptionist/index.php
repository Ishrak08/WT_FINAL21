...
<?php 
  ...
  $data = $db->displayRecord("receptionist");
    ...
    <div class="admin-wrapper">
      ...
      <div class="admin-content">
        <div class="button-group">
          ...
          <a style="background:grey;pointer-events: none;" href="index.php" class="btn btn-big">Manage receptionist</a>
        </div>
        <input type="text" name="search" onkeyup="showmyuser()" class="search-bar search-input" id="uname" placeholder="Search">

        <div class="content">
          <h2 class="page-title">Manage receptionist</h2>
