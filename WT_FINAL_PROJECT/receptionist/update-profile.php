...
{
    $update=$db->updateSingleRecord($_POST,"receptionist",$currentUser);
    if($update)
    {
        ...
        <div class="admin-content">
            <div class="content">
                ...
                <?php
                    ...
                    $data = $db->displaySingleRecord("receptionist",$currentUser);
                    if($data)
                    {
                        foreach($data as $value)
                        {
                ?>
                <form action="update-profile.php" method="post" name="receptionistform"
                    onsubmit="return receptionistvalidate()">
                    <div>
