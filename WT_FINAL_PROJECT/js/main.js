...
function Pharmacistvalidate() {
  var name = document.forms["receptionistform"]["username"].value;
  if(name==""){
    alert("Please enter the name");
    return false;
  }
  ...
  var email = document.forms["receptionistform"]["email"].value;
  if(email=="")
  {
    alert("Please enter email");
    return false;
  ...
  var phone = document.forms["receptionistform"]["phone"].value;
  if(phone.length!=11 )
  {
    alert("Not a valid phone Number");
    return false;
  ...
  var password = document.forms["receptionistform"]["password"].value;
  if(password==""){
    alert("Please enter password");
    return false;
  }
